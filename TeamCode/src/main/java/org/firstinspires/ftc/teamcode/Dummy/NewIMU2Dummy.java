   ...
   // public DcMotor FRMotor = null;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive())
        {
           ...
           /* if ()
                BRMotor.setPower(-power -correction);
                FRMotor.setPower(-power -correction);
                BRMotor.setPower(-power -correction);
                FRMotor.setPower(-power -correction);
            } else {
                BLMotor.setPower(-power -correction / 180);
                FLMotor.setPower(-power -correction / 180);
                BRMotor.setPower(-power / 180);
                FRMotor.setPower(-power / 180);
            }
            */
